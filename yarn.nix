{
  ...
  packages = [
    ...
    {
      name = "axios___axios_1.6.4.tgz";
      path = fetchurl {
        name = "axios___axios_1.6.4.tgz";
        url = "https://registry.yarnpkg.com/axios/-/axios-1.6.4.tgz";
        sha512 = "heJnIs6N4aa1eSthhN9M5ioILu8Wi8vmQW9iHQ9NUvfkJb0lEEDUiIdQNAuBtfUt3FxReaKdpQA5DbmMOqzF/A==";
      };
    }
    {
