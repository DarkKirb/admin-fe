{
  ...
  packages = [
    ...
    {
      name = "marked___marked_11.0.1.tgz";
      path = fetchurl {
        name = "marked___marked_11.0.1.tgz";
        url = "https://registry.yarnpkg.com/marked/-/marked-11.0.1.tgz";
        sha512 = "P4kDhFEMlvLePBPRwOcMOv6+lYUbhfbSxJFs3Jb4Qx7v6K7l+k8Dxh9CEGfRvK71tL+qIFz5y7Pe4uzt4+/A3A==";
      };
    }
    {
