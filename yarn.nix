{
  ...
  packages = [
    ...
    {
      name = "marked___marked_11.0.0.tgz";
      path = fetchurl {
        name = "marked___marked_11.0.0.tgz";
        url = "https://registry.yarnpkg.com/marked/-/marked-11.0.0.tgz";
        sha512 = "2GsW34uXaFEGTQ/+3rCnNC6vUYTAgFuDLGl70v/aWinA5mIJtTrrFAmfbLOfVvgPyxXuDVL9He/7reCK+6j3Sw==";
      };
    }
    {
